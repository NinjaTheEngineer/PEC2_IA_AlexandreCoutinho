...
namespace BBUnity.Actions
{
    ...
    public class MoveToRandomHiddenPosition : GOAction
    {
        ...
        {
            boxCollider = area != null ? area.GetComponent<BoxCollider>() : null;
        ...
        private Vector3 getRandomPosition()
        {
            ...
            if (boxCollider != null)
            {
                Vector3 newPos = new Vector3(UnityEngine.Random.Range(area.transform.position.x - area.transform.localScale.x * boxCollider.size.x * 0.5f,
                ...
                while((newPos-cop.transform.position).sqrMagnitude<(closeDistance*closeDistance)) {
                    newPos = new Vector3(UnityEngine.Random.Range(area.transform.position.x - area.transform.localScale.x * boxCollider.size.x * 0.5f,
                                                            area.transform.position.x + area.transform.localScale.x * boxCollider.size.x * 0.5f),
                                   area.transform.position.y,
                                   UnityEngine.Random.Range(area.transform.position.z - area.transform.localScale.z * boxCollider.size.z * 0.5f,
                                                            area.transform.position.z + area.transform.localScale.z * boxCollider.size.z * 0.5f));
